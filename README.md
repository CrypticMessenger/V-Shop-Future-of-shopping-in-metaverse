# V-Shop: Meta-Commerce- The future of shopping in metaverse

``` A-frame, Networked-a-frame, node.js, MindAR```
...
- support of NFTs for shopping.
- Check out page.
- Improved loading speed and buffer.
